# 13. В реализации метода `size` мы подсчитываем количество узлов в списке.
# Альтернативной стратегией было бы хранить количество узлов
# в дополнительном поле данных в голове списка.
#
# Измените класс UnorderedList, чтобы включить в него эту информацию,
# и перепишите метод size.
